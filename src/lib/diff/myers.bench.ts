...
const randomString = (n: number) => btoa(crypto.getRandomValues(new Uint8Array(n)).reduce((a, b) => a + String.fromCharCode(b), ''));

const len = 1e03;
const opts = { time: 500, iterations: 1 };

bench('Myers 1kchar heterogenous', () => {

...
test("Hunt-Szymanski algorithm returns expected results", () => {
  ...
  expect(huntSzymanski('azzzzzzzzzzzzzzzazzzzzzzzzzzzzzza', 'bbbaababzz')).toBe(4);
  expect(huntSzymanski('ciiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiii', 'icu')).toBe(1);
